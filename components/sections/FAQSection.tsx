...
const faqData = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Sí, puedes participar con licencia federada o con seguro del día. El seguro del día tiene un coste de 10 euros y puede contratarse durante el proceso de inscripción.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "¿Puedo cambiar de recorrido el día del evento?",
        answer:
          "Sí, puedes cambiar entre los dos recorridos oficiales el mismo día del evento en la zona de acreditaciones, siempre que haya disponibilidad en el recorrido que desees.",
      },
    ],
  },
]
          ...
          <div className="text-center mt-20">
            <div className="bg-brand-black text-white border-l-4 border-brand-gold p-8 lg:p-12 shadow-2xl">
              ...
              <p className="text-white/90 mb-8 leading-relaxed text-lg">
                Para cualquier consulta: escríbenos a legendariagranfondo@gmail.com o llámanos al +34 692 61 57 36.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <a
                  href="tel:+34692615736"
                ...
                <a
                  href="mailto:legendariagranfondo@gmail.com"
